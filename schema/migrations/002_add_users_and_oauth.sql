...
-- Description: Creates users table to support Google OAuth authentication for the dashboard.
--              The domain column is used for access control (restricting to specific email domains).
-- Date: 2025-11-09
