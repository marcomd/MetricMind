...
# Migration: Create Standard Views
# Original file: postgres_views.sql
# Original date: 2025-11-09 (updated 2025-11-20 for weight analysis)
# Converted from SQL to Sequel format
#
# Creates standard analytics views for team-wide reporting
# Includes materialized views for performance optimization
#
# Timestamp: 20251112080000 (after weight/ai_tools columns added)
# Dependencies: Base schema + category + weight + ai_tools columns
...
Sequel.migration do
  ...
  down do
    run <<-SQL
      ...
      DROP VIEW IF EXISTS v_reverted_commits CASCADE;
      DROP VIEW IF EXISTS v_ai_tools_by_repo CASCADE;
      DROP VIEW IF EXISTS v_ai_tools_stats CASCADE;
